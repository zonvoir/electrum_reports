            ...
            <div class="mb-4">
                <div class="row g-3">
                    ...
                    <div class="col-auto">
                        ...
                        <button class="btn btn-primary" id="addLayout" data-bs-toggle="modal" data-bs-target="#addLayoutModal"><span class="fas fa-plus me-2"></span>Add Layout</button>
                    </div>
                </div>
            </div>
            <div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
                <div class="table-responsive scrollbar-overlay mx-n1 px-1" style="padding: 10px !important;">
                    <table id="layouts-table" class="table table-sm fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="sort align-middle text-start" scope="col" data-sort="total-orders" style="width:30%">Layout Name</th>
                                <th class="sort align-middle text-end ps-3" scope="col" style="width:10%">DELETE</th>
                                <th class="sort align-middle ps-7" scope="col" style="width:10%">EDIT</th>
                            </tr>
                        </thead>
                        <tbody class="list" id="layouts-table-body" style="padding: 20px !important;">
